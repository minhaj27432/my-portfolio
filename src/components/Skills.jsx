...
// Note: I removed 'SiCsharp' and 'SiLivewire' from imports to prevent crashes. 
// We will use text or standard icons for them.
...
const Skills = () => {
  ...
  const techs = [
    ...
    // Using a text badge for Livewire to be safe
    ...
    // Using a text badge for C# to prevent crash
  ...
  return (
    <div name="skills" className="w-full min-h-screen bg-slate-900 relative py-10">
      ...
      <div className="max-w-screen-xl mx-auto p-4 flex flex-col justify-center w-full h-full text-white relative z-10">
        ...
        <motion.div 
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 text-center py-8 px-4 sm:px-0"
        >
